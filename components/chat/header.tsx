...
export default function ChatHeader({
  ...
  return (
    <div className="z-10 flex justify-center items-center fixed top-0 w-full p-5 bg-pink-200 shadow-[0_10px_15px_-3px_rgba(255,255,255,1)]">
      <div className="flex w-full">
        ...
        <div className="flex-0 w-[100px] flex justify-end items-center">
          <Button
            ...
            className="gap-2 shadow-sm shadow-pink-500"
            variant="outline"
            size="sm"
          >
